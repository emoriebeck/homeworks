...
There is a negative effect of residual positive events on self-esteem (b = `r (tab6 %>% filter(term == "posmn\\_lag\\_1"))$b`; 95\% CI `r (tab6 %>% filter(term == "posmn\\_lag\\_1"))$CI`). The previous day's positive events predict lower self esteem.    
