...
Sector is also a significant predictor of the the level 1 slope for minority -- that is, math achievement varies as a function of both minority status and school sector, $\gamma01 = `r (tab3 %>% filter(term == "minorityMinority:sectorCatholic"))$b`$, bootstrapped 95\% CI $`r (tab3 %>% filter(term == "minorityMinority:sectorCatholic"))$CI`$. In other words, Minority students at Catholic high schools have math achievement that is on average $`r (tab3 %>% filter(term == "minorityMinority:sectorCatholic"))$b`$ than non-minority students at public high schools $`r (tab3 %>% filter(term == "(Intercept)"))$b`$.

## Part c 
Does sector significantly predict the Level 1 slope for ses ($\beta_{3j}$)?  If so, provide an interpretation of the relationship.  

Sector is also a significant predictor of the the level 1 slope for ses -- that is, math achievement varies as a function of both minority status and school sector, $\gamma01 = `r (tab3 %>% filter(term == "sectorCatholic:GC.ses"))$b`$, bootstrapped 95\% CI $`r (tab3 %>% filter(term == "sectorCatholic:GC.ses"))$CI`$. In other words, Minority students at Catholic high schools have math achievement that is on average $`r (tab3 %>% filter(term == "minorityMinority:sectorCatholic"))$b`$ than non-minority students at public high schools $`r (tab3 %>% filter(term == "(Intercept)"))$b`$.
