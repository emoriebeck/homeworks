...
\hspace{1em}verbal & 30.31 & [29.39, 31.25]\\
\hspace{1em}spatial & 30.27 & [29.43, 30.95]\\
\hspace{1em}verbal:order & -0.93 & [-2.39, -0.37]\\
\hspace{1em}spatial:order & -0.38 & [-1.01, 0.06]\\
\hspace{1em}verbal:fam\_size\_GMC & 0.01 & [-0.39, 0.53]\\
\hspace{1em}spatial:fam\_size\_GMC & -0.06 & [-0.73, 0.12]\\
\hspace{1em}verbal:order:fam\_size\_GMC & -0.00 & [-0.49, 0.27]\\
\hspace{1em}spatial:order:fam\_size\_GMC & 0.14 & [-0.17, 0.66]\\
\addlinespace[0.3em]
\multicolumn{3}{l}{\textbf{Random Parts}}\\
\hspace{1em}$\tau_{00}$ & 9.05 & [6.19, 9.56]\\
\hspace{1em}$\tau_{11}$ & 8.68 & [7.65, 9.21]\\
$R^2_m$ & 0.00 & \\
$R^2_c$ & 0.72 & \\
\bottomrule
\end{tabular}
...
\addlinespace[0.3em]
\multicolumn{3}{l}{\textbf{Fixed Parts}}\\
\hspace{1em}verbal & 30.30 & [29.22, 30.74]\\
\hspace{1em}spatial & 30.27 & [29.12, 30.60]\\
\hspace{1em}verbal:order & -0.93 & [-1.65, -0.19]\\
\hspace{1em}spatial:order & -0.40 & [-0.72, 0.70]\\
\addlinespace[0.3em]
\multicolumn{3}{l}{\textbf{Random Parts}}\\
\hspace{1em}$\tau_{00}$ & 9.05 & [7.77, 10.14]\\
\hspace{1em}$\tau_{11}$ & 8.66 & [6.84, 9.43]\\
$R^2_m$ & 0.00 & \\
$R^2_c$ & 0.72 & \\
\bottomrule
\end{tabular}
...
\addlinespace[0.3em]
\multicolumn{3}{l}{\textbf{Fixed Parts}}\\
\hspace{1em}verbal & 29.84 & [29.19, 31.30]\\
\hspace{1em}spatial & 30.07 & [29.56, 31.24]\\
\addlinespace[0.3em]
\multicolumn{3}{l}{\textbf{Random Parts}}\\
\hspace{1em}$\tau_{00}$ & 9.22 & [8.10, 9.79]\\
\hspace{1em}$\tau_{11}$ & 8.71 & [7.66, 9.34]\\
$R^2_m$ & 0.00 & \\
$R^2_c$ & 0.72 & \\
\bottomrule
\end{tabular}
...
\NormalTok{Model_}\DecValTok{5}\NormalTok{ <-}\StringTok{ }\KeywordTok{lmer}\NormalTok{(score }\OperatorTok{~}\StringTok{ }
\StringTok{                }\OperatorTok{-}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{verbal }\OperatorTok{+}\StringTok{ }\NormalTok{spatial }\OperatorTok{+}\StringTok{ }\CommentTok{# level 1}
\StringTok{                }\NormalTok{(}\DecValTok{1} \OperatorTok{|}\StringTok{ }\NormalTok{child_unique) }\OperatorTok{+}
\StringTok{                }\NormalTok{(}\DecValTok{1} \OperatorTok{|}\StringTok{ }\NormalTok{family),}
                \DataTypeTok{data=}\NormalTok{dat) }
