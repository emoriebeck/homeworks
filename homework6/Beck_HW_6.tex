...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res_fit2_df }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{term =} \KeywordTok{rownames}\NormalTok{(.)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{rename}\NormalTok{(}\DataTypeTok{b =}\NormalTok{ Estimate) }\OperatorTok{%>%}
...
\includegraphics{Beck_HW_6_files/figure-latex/unnamed-chunk-10-1.pdf}
