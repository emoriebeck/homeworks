...
\begin{kframe}\begin{verbatim}
## [1] "Case 395 removed. 3 factors remain. This is the 19 round"
\end{verbatim}
\end{kframe}
...
\begin{kframe}\begin{verbatim}
## [1] "Case NA removed. 3 factors remain. This is the 21 round"
\end{verbatim}
\begin{alltt}
...
In total, using the mardia test, it took 21 rounds to remove the following outliers: cases .
...
m & PC1 & PC2 & PC3\\
\midrule
SS loadings & 4.18 & 1.75 & 1.57\\
Proportion Var & 0.35 & 0.15 & 0.13\\
Cumulative Var & 0.35 & 0.49 & 0.63\\
Proportion Explained & 0.56 & 0.23 & 0.21\\
Cumulative Proportion & 0.56 & 0.79 & 1.00\\
\bottomrule
\end{tabular}
