...
The extracted components account for \Sexpr{round(pca_final$communality["Geometry"], 4)*100}\% of the variance in the original Geometry variable, while it accounted for \Sexpr{round(pca_final$communality["Geometry"], 4)*100}\% in the original model.  
