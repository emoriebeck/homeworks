...
\hlstd{MO1} \hlkwb{<-} \hlkwd{sum}\hlstd{(Class_T[}\hlnum{1}\hlstd{, ])}
\hlstd{MO2} \hlkwb{<-} \hlkwd{sum}\hlstd{(Class_T[}\hlnum{2}\hlstd{, ])}
\hlstd{MP1} \hlkwb{<-} \hlstd{MO1}
\hlstd{MP2} \hlkwb{<-} \hlstd{MO2}

\hlcom{# Expected agreement}
\hlstd{E} \hlkwb{<-} \hlstd{(MO1} \hlopt{*} \hlstd{MP1}\hlopt{/}\hlstd{N)} \hlopt{+} \hlstd{(MO2} \hlopt{*} \hlstd{MP2}\hlopt{/}\hlstd{N)}
...
\end{verbatim}
\begin{alltt}
\hlstd{chi_squared} \hlkwb{<-} \hlstd{(((O} \hlopt{-} \hlstd{E)}\hlopt{^}\hlnum{2}\hlstd{)}\hlopt{/}\hlstd{E)} \hlopt{+} \hlstd{((((}\hlnum{500} \hlopt{-} \hlstd{O)} \hlopt{-} \hlstd{(}\hlnum{500} \hlopt{-} \hlstd{E))}\hlopt{^}\hlnum{2}\hlstd{)}\hlopt{/}\hlstd{(}\hlnum{500} \hlopt{-}\hlstd{E))}
\hlstd{chi_squared}
\end{alltt}
\begin{verbatim}
## [1] 1065.207
