...
## 2 DV2   Group  3.00  48.6  16.2       7.14 0.000222      
## 3 DV3   Group  3.00  30.9  10.3       6.03 0.000833      
## 4 DV4   Group  3.00  21.8   7.28      3.79 0.0128
\end{verbatim}
\end{kframe}
\end{knitrout}
...
DV1+DV2 v. DV3+DV4 & \textbf{-0.88} & \textbf{[-1.70, -0.06]}\\
DV1+DV2+DV3 v DV4 & \textbf{-2.23} & \textbf{[-3.16, -1.31]}\\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
G1 & -0.33 & [-0.79, 0.13] & -0.36 & [-0.77, 0.05] & -0.36 & [-0.94, 0.22]\\
G1vG2+3+4 & \textbf{-0.45} & \textbf{[-0.87, -0.04]} & \textbf{-1.43} & \textbf{[-1.91, -0.94]} & -0.60 & [-1.27, 0.07]\\
G2vG3 & 0.55 & [-0.12, 1.22] & -0.50 & [-1.08, 0.08] & 0.24 & [-0.58, 1.06]\\
\bottomrule
\end{tabular}
\end{table}
