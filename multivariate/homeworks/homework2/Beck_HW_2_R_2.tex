...
\midrule
G1 & -0.16 & [-2.12, 1.80] & -0.72 & [-1.85, 0.41] & -0.36 & [-1.16, 0.44]\\
G1vG2+3+4 & 2.00 & [-4.77, 8.77] & -1.12 & [-5.03, 2.79] & -1.80 & [-4.57, 0.97]\\
G2vG3 & 1.64 & [-1.13, 4.41] & -1.00 & [-2.60, 0.60] & 0.24 & [-0.89, 1.37]\\
\bottomrule
\end{tabular}
\end{table}
